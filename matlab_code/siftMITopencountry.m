srcFiles = dir('/Users/EthanCohen/Documents/COS424/FinalProject/424Final-master/data/MITopencountry/*jpg');
...
for i = 1: length(srcFiles)
    ...
    mat_name = strcat(matlab_dir, '/', 'MITopencountry', '/', filename, '.mat');
    I = imread(filename);
    A = single(I);
    [f,d] = vl_sift(A);
    save(mat_name, 'f', 'd');
