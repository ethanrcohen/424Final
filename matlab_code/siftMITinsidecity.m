srcFiles = dir('/Users/EthanCohen/Documents/COS424/FinalProject/424Final-master/data/MITinsidecity/*jpg');
...
for i = 1: length(srcFiles)
    ...
    mat_name = strcat(matlab_dir, '/', 'MITinsidecity', '/', filename, '.mat');
    I = imread(filename);
    A = single(I);
    [f,d] = vl_sift(A);
    save(mat_name, 'f', 'd');
